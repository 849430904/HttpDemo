...
public class MainActivityCryptTest extends AppCompatActivity {

    private static final String NAMESPACE = "http://tempuri.org/" ;
    private static final String URL="https://www.arriba-tpe.com:89/ws_app.asmx";
    private static final String METHOD_NAME = "record_list";
    private static final String SOAP_ACTION = "http://tempuri.org/record_list";
  ...
  //  String deviceId = tm.getDeviceId();
    ...
    public String getJson(){
        String jsonString =Dnoutput;//json字符串
        try {
            JSONObject result = new JSONObject(jsonString);//转换为JSONObject
            int num = result.length();
            JSONArray nameList = result.getJSONArray("num");//获取JSONArray
    ...
    public String convert(String type){
        ...
        try
        {
            ...
            request.addProperty("record_type","debit");
            request.addProperty("page ","1");
            request.addProperty("pages","10");
